...
# Request 15 gigabyte tmp
#$ -l tmpfs=15G

# Set the name of the job.
#$ -N quarry_interpolations_smp_batch1
...
source /home/tcrnbgh/quarry_hpc/init_myriad.sh
echo "done!"
...
echo "running gerun..."
gerun /home/tcrnbgh/quarry_hpc/RMPISNOW_bgh < /home/tcrnbgh/Scratch/quarry_data/quarry_hpc/rscript/2_interpolate_analyse_hpc_jackknife_batch1.R
echo "done!"
