...
#$ -N quarry_interpolations_hole_batch2
...
echo "running gerun..."
gerun /home/tcrnbgh/quarry_hpc/RMPISNOW_bgh < /home/tcrnbgh/Scratch/quarry_data/quarry_hpc/rscript/2_interpolate_analyse_hpc_hole_batch2.R
echo "done!"
